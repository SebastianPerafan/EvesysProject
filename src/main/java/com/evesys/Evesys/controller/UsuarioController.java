...
public class UsuarioController {
   ...
   // Procesa y guarda el nuevo usuario del formulario público
    ...
    // Muestra una lista detallada solo de los clientes (rol USER)
    @GetMapping("/admin/clientes")
    public String listarClientes(Model model) {
    // Usamos el nuevo método del repositorio para obtener solo los usuarios con rol "USER"
    model.addAttribute("clientes", usuarioRepository.findByRol("USER"));
    return "admin/clientes"; // Llama a una nueva vista que crearemos
    }
